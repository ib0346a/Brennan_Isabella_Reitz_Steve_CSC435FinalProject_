						...
						<?php
							...
							while (!feof($spices_List)) {
								...
								if (file_exists("images/Dry_Goods/Spices/".$Spices_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart (\''.$Spices_Name1_NoSpace.'\','.'\''.$Spices_Price1_NoDolla.'\')">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Dry_Goods/Spices/".$Spices_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart (\''.$Spices_Name2_NoSpace.'\','.'\''.$Spices_Price2_NoDolla.'\')">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
