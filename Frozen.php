					...
					<table style="width:100%">
						<?php
							...
							while (!feof($fruit_veggie_List)) {
								...
								$fruit_veggie_Price1_NoDolla=str_replace("$","",$fruit_veggie_Price1);
								...
								$fruit_veggie_Price2_NoDolla=str_replace("$","",$fruit_veggie_Price2);
								...
								if (file_exists("images/Frozen_Food/Fruit_Veggies/".$fruit_veggie_Img1.".jpg")) {
									...
									$AddtoCart1='<button class="Add_to_Cart" onclick="Add_to_Cart (\''.$fruit_veggie_Name1_NoSpace.'\','.'\''.$fruit_veggie_Price1_NoDolla.'\')">Add to Cart</button>';
								}
								else{
									$image="";
									$AddtoCart1="";
								...
								if (file_exists("images/Frozen_Food/Fruit_Veggies/".$fruit_veggie_Img2.".jpg")) {
									...
									$AddtoCart2='<button class="Add_to_Cart" onclick="Add_to_Cart (\''.$fruit_veggie_Name2_NoSpace.'\','.'\''.$fruit_veggie_Price2_NoDolla.'\')">Add to Cart</button>';
								}
								else{
									$image2="";
									$AddtoCart2="";
